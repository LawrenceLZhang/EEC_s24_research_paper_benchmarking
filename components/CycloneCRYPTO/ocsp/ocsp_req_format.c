...
cerror_t ocspFormatRequest(const OcspRequest *request, uint8_t *output,
   size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t ocspFormatTbsRequest(const OcspTbsRequest *tbsRequest, uint8_t *output,
   size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t ocspFormatVersion(OcspVersion version, uint8_t *output,
   size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t ocspFormatRequestList(const OcspSingleRequest *requestList,
...
cerror_t ocspFormatSingleRequest(const OcspSingleRequest *singleRequest,
...
cerror_t ocspFormatCertId(const OcspCertId *certId, uint8_t *output,
   size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t ocspFormatHashAlgo(const OcspCertId *certId, uint8_t *output,
   size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t ocspFormatRequestExtensions(const OcspExtensions *extensions,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t ocspFormatNonceExtension(const X509OctetString *nonce, uint8_t *output,
   size_t *written)
{
   cerror_t error;
   size_t n;
