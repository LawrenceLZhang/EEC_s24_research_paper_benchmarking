...
cerror_t ocspClientGenerateNonce(OcspClientContext *context)
{
   cerror_t error;
...
cerror_t ocspClientFormatHeader(OcspClientContext *context)
{
   bool_t defaultPort;
...
cerror_t ocspClientFormatRequest(OcspClientContext *context, const char_t *cert,
...
cerror_t ocspClientParseHeader(OcspClientContext *context)
{
