...
cerror_t ocspValidateResponse(const OcspResponse *response,
...
cerror_t ocspCheckResponseSignature(const OcspBasicResponse *basicResponse,
...
cerror_t ocspCheckResponderCert(const OcspResponderId *responderId,
...
cerror_t ocspCheckResponderId(const OcspResponderId *responderId,
   const X509CertInfo *issuerCertInfo)
{
   cerror_t error;
...
cerror_t ocspCheckCertId(const OcspCertId *certId, const X509CertInfo *certInfo,
   const X509CertInfo *issuerCertInfo)
{
   cerror_t error;
...
cerror_t ocspCheckValidity(const OcspSingleResponse *singleResponse)
{
   cerror_t error;
   time_t currentTime;
...
cerror_t ocspCheckNonce(const OcspExtensions *extensions, const uint8_t *nonce,
   size_t nonceLen)
{
   cerror_t error;
