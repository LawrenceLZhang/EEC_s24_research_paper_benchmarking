...
cerror_t pemImportCertificate(const char_t *input, size_t inputLen,
...
cerror_t pemImportCrl(const char_t *input, size_t inputLen,
   uint8_t *output, size_t *outputLen, size_t *consumed)
{
   cerror_t error;
...
cerror_t pemImportCsr(const char_t *input, size_t inputLen,
...
cerror_t pemImportDhParameters(const char_t *input, size_t length,
   DhParameters *params)
{
...
cerror_t pemImportRsaPublicKey(const char_t *input, size_t length,
...
cerror_t pemImportRsaPrivateKey(const char_t *input, size_t length,
...
cerror_t pemImportDsaPublicKey(const char_t *input, size_t length,
...
cerror_t pemImportDsaPrivateKey(const char_t *input, size_t length,
...
cerror_t pemImportEcParameters(const char_t *input, size_t length,
...
cerror_t pemImportEcPublicKey(const char_t *input, size_t length,
...
cerror_t pemImportEcPrivateKey(const char_t *input, size_t length,
...
cerror_t pemImportEddsaPublicKey(const char_t *input, size_t length,
...
cerror_t pemImportEddsaPrivateKey(const char_t *input, size_t length,
...
cerror_t pemGetPublicKeyType(const char_t *input, size_t length,
   X509KeyType *keyType)
{
   cerror_t error;
   size_t n;
...
cerror_t pemGetPrivateKeyType(const char_t *input, size_t length,
   X509KeyType *keyType)
{
   cerror_t error;
   size_t n;
