...
cerror_t x509FormatSignatureAlgo(const X509SignAlgoId *signatureAlgo,
...
cerror_t x509FormatSignatureValue(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t x509FormatRsaPssParameters(const X509RsaPssParameters *rsaPssParams,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509FormatRsaPssHashAlgo(const X509RsaPssParameters *rsaPssParams,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509FormatRsaPssMaskGenAlgo(const X509RsaPssParameters *rsaPssParams,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509FormatRsaPssMaskGenHashAlgo(const X509RsaPssParameters *rsaPssParams,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509FormatRsaPssSaltLength(const X509RsaPssParameters *rsaPssParams,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
