...
cerror_t x509ParseSubjectPublicKeyInfo(const uint8_t *data, size_t length,
...
cerror_t x509ParseAlgoId(const uint8_t *data, size_t length,
   size_t *totalLength, X509SubjectPublicKeyInfo *publicKeyInfo)
{
   cerror_t error;
   Asn1Tag tag;
...
cerror_t x509ParseRsaPublicKey(const uint8_t *data, size_t length,
...
cerror_t x509ParseDsaPublicKey(const uint8_t *data, size_t length,
...
cerror_t x509ParseDsaParameters(const uint8_t *data, size_t length,
...
cerror_t x509ParseEcPublicKey(const uint8_t *data, size_t length,
...
cerror_t x509ParseEcParameters(const uint8_t *data, size_t length,
...
cerror_t x509ImportRsaPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
cerror_t x509ImportDsaPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
cerror_t x509ImportEcPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
cerror_t x509ImportEcParameters(const X509EcParameters *ecParams,
   EcDomainParameters *params)
{
   cerror_t error;
...
cerror_t x509ImportEddsaPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
