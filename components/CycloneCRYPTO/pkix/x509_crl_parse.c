...
cerror_t x509ParseCrl(const uint8_t *data, size_t length,
   X509CrlInfo *crlInfo)
{
   cerror_t error;
   size_t n;
...
cerror_t x509ParseTbsCertList(const uint8_t *data, size_t length,
...
cerror_t x509ParseCrlVersion(const uint8_t *data, size_t length,
...
cerror_t x509ParseRevokedCertificates(const uint8_t *data, size_t length,
   size_t *totalLength, X509TbsCertList *tbsCertList)
{
   cerror_t error;
   size_t n;
...
cerror_t x509ParseRevokedCertificate(const uint8_t *data, size_t length,
