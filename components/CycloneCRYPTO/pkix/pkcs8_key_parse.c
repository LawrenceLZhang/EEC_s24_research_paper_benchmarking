...
cerror_t pkcs8ParsePrivateKeyInfo(const uint8_t *data, size_t length,
...
cerror_t pkcs8ParsePrivateKeyAlgo(const uint8_t *data, size_t length,
...
cerror_t pkcs8ParseRsaPrivateKey(const uint8_t *data, size_t length,
...
cerror_t pkcs8ParseDsaPrivateKey(const uint8_t *data, size_t length,
...
cerror_t pkcs8ParseEcPrivateKey(const uint8_t *data, size_t length,
...
cerror_t pkcs8ParseEddsaPrivateKey(const uint8_t *data, size_t length,
...
cerror_t pkcs8ParseEncryptedPrivateKeyInfo(const uint8_t *data, size_t length,
...
cerror_t pkcs8ParseEncryptionAlgoId(const uint8_t *data, size_t length,
...
cerror_t pkcs8ImportRsaPrivateKey(const Pkcs8PrivateKeyInfo *privateKeyInfo,
...
cerror_t pkcs8ImportDsaPrivateKey(const Pkcs8PrivateKeyInfo *privateKeyInfo,
...
cerror_t pkcs8ImportEcPrivateKey(const Pkcs8PrivateKeyInfo *privateKeyInfo,
...
cerror_t pkcs8ImportEddsaPrivateKey(const Pkcs8PrivateKeyInfo *privateKeyInfo,
