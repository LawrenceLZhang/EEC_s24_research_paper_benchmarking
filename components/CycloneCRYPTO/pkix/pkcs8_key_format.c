...
cerror_t pkcs8FormatRsaPrivateKey(const RsaPrivateKey *privateKey,
...
cerror_t pkcs8FormatDsaPrivateKey(const DsaPrivateKey *privateKey,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t pkcs8FormatEcPrivateKey(const EcCurveInfo *curveInfo,
...
cerror_t pkcs8FormatEcPublicKey(const EcCurveInfo *curveInfo,
...
cerror_t pkcs8FormatEddsaPrivateKey(const EcCurveInfo *curveInfo,
