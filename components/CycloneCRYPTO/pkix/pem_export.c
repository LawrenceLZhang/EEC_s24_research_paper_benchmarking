...
cerror_t pemExportCertificate(const uint8_t *cert, size_t certLen,
...
cerror_t pemExportCrl(const uint8_t *crl, size_t crlLen,
   char_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t pemExportCsr(const uint8_t *csr, size_t csrLen,
   char_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t pemExportRsaPublicKey(const RsaPublicKey *publicKey,
   char_t *output, size_t *written)
{
...
cerror_t pemExportRsaPrivateKey(const RsaPrivateKey *privateKey,
   char_t *output, size_t *written)
{
#if (RSA_SUPPORT == ENABLED)
   cerror_t error;
...
cerror_t pemExportRsaPssPublicKey(const RsaPublicKey *publicKey,
   char_t *output, size_t *written)
{
#if (RSA_SUPPORT == ENABLED)
   cerror_t error;
...
cerror_t pemExportRsaPssPrivateKey(const RsaPrivateKey *privateKey,
   char_t *output, size_t *written)
{
#if (RSA_SUPPORT == ENABLED)
   cerror_t error;
...
cerror_t pemExportDsaPublicKey(const DsaPublicKey *publicKey,
   char_t *output, size_t *written)
{
...
cerror_t pemExportDsaPrivateKey(const DsaPrivateKey *privateKey,
   char_t *output, size_t *written)
{
#if (DSA_SUPPORT == ENABLED)
   cerror_t error;
...
cerror_t pemExportEcParameters(const EcCurveInfo *curveInfo,
   char_t *output, size_t *written)
{
...
cerror_t pemExportEcPublicKey(const EcCurveInfo *curveInfo,
...
cerror_t pemExportEcPrivateKey(const EcCurveInfo *curveInfo,
...
cerror_t pemExportEddsaPublicKey(const EcCurveInfo *curveInfo,
...
cerror_t pemExportEddsaPrivateKey(const EcCurveInfo *curveInfo,
