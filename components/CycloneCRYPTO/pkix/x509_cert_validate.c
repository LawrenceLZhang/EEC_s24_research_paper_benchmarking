...
cerror_t x509ValidateCertificate(const X509CertInfo *certInfo,
...
cerror_t x509CheckSubjectName(const X509CertInfo *certInfo,
   const char_t *fqdn)
{
   cerror_t error;
   bool_t res;
...
cerror_t x509CheckNameConstraints(const char_t *subjectName,
...
cerror_t x509ParseIpv4Addr(const char_t *str, uint8_t *ipAddr)
{
   cerror_t error;
   int_t i = 0;
   int_t value = -1;
...
cerror_t x509ParseIpv6Addr(const char_t *str, uint8_t *ipAddr)
{
   cerror_t error;
   int_t i = 0;
   int_t j = -1;
