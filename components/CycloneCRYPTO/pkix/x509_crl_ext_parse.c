...
cerror_t x509ParseCrlExtensions(const uint8_t *data, size_t length,
...
cerror_t x509ParseCrlNumber(bool_t critical, const uint8_t *data,
...
cerror_t x509ParseDeltaCrlIndicator(bool_t critical, const uint8_t *data,
...
cerror_t x509ParseIssuingDistrPoint(bool_t critical, const uint8_t *data,
...
cerror_t x509ParseCrlEntryExtensions(const uint8_t *data, size_t length,
...
cerror_t x509ParseReasonCode(bool_t critical, const uint8_t *data,
...
cerror_t x509ParseInvalidityDate(bool_t critical, const uint8_t *data,
...
cerror_t x509ParseCertificateIssuer(bool_t critical, const uint8_t *data,
...
__weak_func cerror_t x509ParseUnknownCrlExtension(const uint8_t *oid,
