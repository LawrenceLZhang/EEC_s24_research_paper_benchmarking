...
cerror_t pemDecodeFile(const char_t *input, size_t inputLen, const char_t *label,
...
cerror_t pemEncodeFile(const void *input, size_t inputLen, const char_t *label,
...
cerror_t pemParseHeader(const char_t *input, size_t inputLen,
