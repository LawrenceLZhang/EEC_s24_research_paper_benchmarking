...
cerror_t x509FormatSubjectPublicKeyInfo(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
cerror_t x509FormatAlgoId(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
cerror_t x509FormatRsaPublicKey(const X509RsaPublicKey *rsaPublicKey,
...
cerror_t x509FormatDsaPublicKey(const X509DsaPublicKey *dsaPublicKey,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509FormatDsaParameters(const X509DsaParameters *dsaParams,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509FormatEcPublicKey(const X509EcPublicKey *ecPublicKey,
   uint8_t *output, size_t *written)
{
...
cerror_t x509FormatEcParameters(const X509EcParameters *ecParams,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509ExportRsaPublicKey(const RsaPublicKey *publicKey,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509ExportRsaPrivateKey(const RsaPrivateKey *privateKey,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509ExportDsaPublicKey(const DsaPublicKey *publicKey,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509ExportDsaPrivateKey(const DsaPrivateKey *privateKey,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509ExportDsaParameters(const DsaDomainParameters *params,
   uint8_t *output, size_t *written)
{
   cerror_t error;
   size_t n;
...
cerror_t x509ExportEcPublicKey(const X509SubjectPublicKeyInfo *publicKeyInfo,
...
cerror_t x509ExportEddsaPublicKey(const EddsaPublicKey *publicKey,
...
cerror_t x509ExportEddsaPrivateKey(const EddsaPrivateKey *privateKey,
