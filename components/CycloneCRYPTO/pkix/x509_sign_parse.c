...
cerror_t x509ParseSignatureAlgo(const uint8_t *data, size_t length,
...
cerror_t x509ParseSignatureValue(const uint8_t *data, size_t length,
...
cerror_t x509ParseRsaPssParameters(const uint8_t *data, size_t length,
...
cerror_t x509ParseRsaPssHashAlgo(const uint8_t *data, size_t length,
   X509RsaPssParameters *rsaPssParams)
{
   cerror_t error;
   Asn1Tag tag;
...
cerror_t x509ParseRsaPssMaskGenAlgo(const uint8_t *data, size_t length,
   X509RsaPssParameters *rsaPssParams)
{
   cerror_t error;
   Asn1Tag tag;
...
cerror_t x509ParseRsaPssMaskGenHashAlgo(const uint8_t *data, size_t length,
   X509RsaPssParameters *rsaPssParams)
{
   cerror_t error;
   Asn1Tag tag;
...
cerror_t x509ParseRsaPssSaltLength(const uint8_t *data, size_t length,
   X509RsaPssParameters *rsaPssParams)
{
   cerror_t error;
   int32_t saltLen;
