...
cerror_t pkcs5Decrypt(const X509AlgoId *encryptionAlgoId,
...
cerror_t pkcs5DecryptPbes1(const X509AlgoId *encryptionAlgoId,
   const char_t *password, const uint8_t *ciphertext, size_t ciphertextLen,
   uint8_t *plaintext, size_t *plaintextLen)
{
   cerror_t error;
...
cerror_t pkcs5DecryptPbes2(const X509AlgoId *encryptionAlgoId,
   const char_t *password, const uint8_t *ciphertext, size_t ciphertextLen,
   uint8_t *plaintext, size_t *plaintextLen)
{
   cerror_t error;
...
cerror_t pkcs5ParsePbes1Params(const uint8_t *data, size_t length,
   Pkcs5Pbes1Params *pbes1Params)
{
   cerror_t error;
   int32_t value;
...
cerror_t pkcs5ParsePbes2Params(const uint8_t *data, size_t length,
   Pkcs5Pbes2Params *pbes2Params)
{
   cerror_t error;
   size_t n;
...
cerror_t pkcs5ParseKeyDerivationFunc(const uint8_t *data, size_t length,
...
cerror_t pkcs5ParsePbkdf2Params(const uint8_t *data, size_t length,
...
cerror_t pkcs5ParseEncryptionScheme(const uint8_t *data, size_t length,
