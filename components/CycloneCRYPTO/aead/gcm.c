...
__weak_func cerror_t gcmInit(GcmContext *context, const CipherAlgo *cipherAlgo,
   void *cipherContext)
{
   uint_t i;
   uint_t j;
...
__weak_func cerror_t gcmEncrypt(GcmContext *context, const uint8_t *iv,
...
__weak_func cerror_t gcmDecrypt(GcmContext *context, const uint8_t *iv,
