...
__weak_func cerror_t ccmEncrypt(const CipherAlgo *cipher, void *context, const uint8_t *n,
...
__weak_func cerror_t ccmDecrypt(const CipherAlgo *cipher, void *context, const uint8_t *n,
...
cerror_t ccmFormatBlock0(size_t q, const uint8_t *n, size_t nLen, size_t aLen,
