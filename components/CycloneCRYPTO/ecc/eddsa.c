...
cerror_t eddsaGenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t eddsaGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
   const EcCurveInfo *curveInfo, EddsaPrivateKey *privateKey)
{
   cerror_t error;
...
cerror_t eddsaGeneratePublicKey(const EcCurveInfo *curveInfo,
