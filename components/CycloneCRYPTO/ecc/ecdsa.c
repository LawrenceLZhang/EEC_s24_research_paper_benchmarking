...
cerror_t ecdsaWriteSignature(const EcdsaSignature *signature, uint8_t *data,
   size_t *length)
{
   cerror_t error;
   size_t k;
...
cerror_t ecdsaReadSignature(const uint8_t *data, size_t length,
...
__weak_func cerror_t ecdsaGenerateSignature(const PrngAlgo *prngAlgo, void *prngContext,
...
__weak_func cerror_t ecdsaVerifySignature(const EcDomainParameters *params,
