...
cerror_t ecLoadDomainParameters(EcDomainParameters *params,
...
__weak_func cerror_t ecGenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t ecGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
   const EcDomainParameters *params, EcPrivateKey *privateKey)
{
   cerror_t error;
...
cerror_t ecGeneratePublicKey(const EcDomainParameters *params,
...
cerror_t ecCopy(EcPoint *r, const EcPoint *s)
{
   cerror_t error;
...
cerror_t ecImport(const EcDomainParameters *params, EcPoint *r,
...
cerror_t ecExport(const EcDomainParameters *params, const EcPoint *a,
...
cerror_t ecProjectify(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   cerror_t error;
...
__weak_func cerror_t ecAffinify(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   cerror_t error;
   Mpi a;
...
cerror_t ecDouble(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   cerror_t error;
   Mpi t1;
...
cerror_t ecAdd(const EcDomainParameters *params, EcPoint *r,
...
cerror_t ecFullAdd(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s, const EcPoint *t)
{
   cerror_t error;
...
cerror_t ecFullSub(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s, const EcPoint *t)
{
   cerror_t error;
   EcPoint u;
...
__weak_func cerror_t ecMult(const EcDomainParameters *params, EcPoint *r, const Mpi *d,
   const EcPoint *s)
{
   cerror_t error;
   uint_t i;
...
cerror_t ecTwinMult(const EcDomainParameters *params, EcPoint *r,
...
cerror_t ecAddMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   cerror_t error;
...
cerror_t ecSubMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   cerror_t error;
...
__weak_func cerror_t ecMulMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   cerror_t error;
...
__weak_func cerror_t ecSqrMod(const EcDomainParameters *params, Mpi *r, const Mpi *a)
{
   cerror_t error;
