...
typedef cerror_t (*EcFastModAlgo)(Mpi *a, const Mpi *p);
...
cerror_t secp128r1Mod(Mpi *a, const Mpi *p);
cerror_t secp128r2Mod(Mpi *a, const Mpi *p);
cerror_t secp160k1Mod(Mpi *a, const Mpi *p);
cerror_t secp160r1Mod(Mpi *a, const Mpi *p);
cerror_t secp160r2Mod(Mpi *a, const Mpi *p);
cerror_t secp192k1Mod(Mpi *a, const Mpi *p);
cerror_t secp192r1Mod(Mpi *a, const Mpi *p);
cerror_t secp224k1Mod(Mpi *a, const Mpi *p);
cerror_t secp224r1Mod(Mpi *a, const Mpi *p);
cerror_t secp256k1Mod(Mpi *a, const Mpi *p);
cerror_t secp256r1Mod(Mpi *a, const Mpi *p);
cerror_t secp384r1Mod(Mpi *a, const Mpi *p);
cerror_t secp521r1Mod(Mpi *a, const Mpi *p);
cerror_t sm2Mod(Mpi *a, const Mpi *p);
