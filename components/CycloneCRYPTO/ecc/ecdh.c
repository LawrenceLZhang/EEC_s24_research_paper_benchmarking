...
cerror_t ecdhGenerateKeyPair(EcdhContext *context, const PrngAlgo *prngAlgo,
   void *prngContext)
{
   cerror_t error;
...
cerror_t ecdhCheckPublicKey(const EcDomainParameters *params, EcPoint *publicKey)
{
   bool_t valid;
...
cerror_t ecdhComputeSharedSecret(EcdhContext *context,
