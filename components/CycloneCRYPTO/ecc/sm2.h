...
cerror_t sm2GenerateSignature(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t sm2VerifySignature(const EcDomainParameters *params,
...
cerror_t sm2ComputeZa(const HashAlgo *hashAlgo, HashContext *hashContext,
