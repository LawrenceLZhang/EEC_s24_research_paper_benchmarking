...
cerror_t kyber1024GenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
   uint8_t *pk, uint8_t *sk);

cerror_t kyber1024Encapsulate(const PrngAlgo *prngAlgo, void *prngContext,
   uint8_t *ct, uint8_t *ss, const uint8_t *pk);

cerror_t kyber1024Decapsulate(uint8_t *ss, const uint8_t *ct, const uint8_t *sk);
