...
cerror_t sntrup761GenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t sntrup761Encapsulate(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t sntrup761Decapsulate(uint8_t *ss, const uint8_t *ct, const uint8_t *sk)
{
   OQS_STATUS status;
