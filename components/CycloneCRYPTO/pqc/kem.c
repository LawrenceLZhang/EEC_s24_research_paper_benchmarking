...
cerror_t kemGenerateKeyPair(KemContext *context, const PrngAlgo *prngAlgo,
   void *prngContext)
{
   cerror_t error;
...
cerror_t kemLoadPublicKey(KemContext *context, const uint8_t *pk)
{
   cerror_t error;
...
cerror_t kemEncapsulate(KemContext *context, const PrngAlgo *prngAlgo,
...
cerror_t kemDecapsulate(KemContext *context, const uint8_t *ct, uint8_t *ss)
{
   cerror_t error;
