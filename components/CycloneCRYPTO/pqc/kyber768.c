...
cerror_t kyber768GenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t kyber768Encapsulate(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t kyber768Decapsulate(uint8_t *ss, const uint8_t *ct, const uint8_t *sk)
{
   OQS_STATUS status;
