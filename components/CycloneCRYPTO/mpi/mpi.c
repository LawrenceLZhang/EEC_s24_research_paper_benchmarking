...
cerror_t mpiGrow(Mpi *r, uint_t size)
{
   cerror_t error;
#if (CRYPTO_STATIC_MEM_SUPPORT == DISABLED)
   uint_t *data;
...
cerror_t mpiSetBitValue(Mpi *r, uint_t index, uint_t value)
{
   cerror_t error;
   uint_t n1;
   uint_t n2;
...
cerror_t mpiCopy(Mpi *r, const Mpi *a)
{
   cerror_t error;
   uint_t n;
...
cerror_t mpiSetValue(Mpi *r, int_t a)
{
   cerror_t error;
...
cerror_t mpiRand(Mpi *r, uint_t length, const PrngAlgo *prngAlgo,
   void *prngContext)
{
   cerror_t error;
   uint_t m;
...
cerror_t mpiRandRange(Mpi *r, const Mpi *p, const PrngAlgo *prngAlgo,
   void *prngContext)
{
   cerror_t error;
   uint_t n;
...
__weak_func cerror_t mpiCheckProbablePrime(const Mpi *a)
{
...
cerror_t mpiImport(Mpi *r, const uint8_t *data, uint_t length, MpiFormat format)
{
   cerror_t error;
   uint_t i;
...
cerror_t mpiExport(const Mpi *a, uint8_t *data, uint_t length, MpiFormat format)
{
   uint_t i;
   uint_t n;
   cerror_t error;
...
cerror_t mpiAdd(Mpi *r, const Mpi *a, const Mpi *b)
{
   cerror_t error;
   int_t sign;
...
cerror_t mpiAddInt(Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
cerror_t mpiSub(Mpi *r, const Mpi *a, const Mpi *b)
{
   cerror_t error;
   int_t sign;
...
cerror_t mpiSubInt(Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
cerror_t mpiAddAbs(Mpi *r, const Mpi *a, const Mpi *b)
{
   cerror_t error;
   uint_t i;
   uint_t n;
...
cerror_t mpiSubAbs(Mpi *r, const Mpi *a, const Mpi *b)
{
   cerror_t error;
   uint_t c;
   uint_t d;
...
cerror_t mpiShiftLeft(Mpi *r, uint_t n)
{
   cerror_t error;
   uint_t i;
   uint_t k;
...
cerror_t mpiShiftRight(Mpi *r, uint_t n)
{
   uint_t i;
   uint_t m;
...
__weak_func cerror_t mpiMul(Mpi *r, const Mpi *a, const Mpi *b)
{
   cerror_t error;
   int_t i;
   int_t m;
...
cerror_t mpiMulInt(Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
cerror_t mpiDiv(Mpi *q, Mpi *r, const Mpi *a, const Mpi *b)
{
   cerror_t error;
   uint_t m;
   uint_t n;
...
cerror_t mpiDivInt(Mpi *q, Mpi *r, const Mpi *a, int_t b)
{
   uint_t value;
   Mpi t;
...
cerror_t mpiMod(Mpi *r, const Mpi *a, const Mpi *p)
{
   cerror_t error;
   int_t sign;
   uint_t m;
...
cerror_t mpiAddMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   cerror_t error;
...
cerror_t mpiSubMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   cerror_t error;
...
__weak_func cerror_t mpiMulMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   cerror_t error;
...
__weak_func cerror_t mpiInvMod(Mpi *r, const Mpi *a, const Mpi *p)
{
   cerror_t error;
   Mpi b;
   Mpi c;
...
__weak_func cerror_t mpiExpMod(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
   cerror_t error;
   int_t i;
   int_t j;
...
__weak_func cerror_t mpiExpModFast(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
...
__weak_func cerror_t mpiExpModRegular(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
   //Perform modular exponentiation
   return mpiExpMod(r, a, e, p);
}
...
cerror_t mpiMontgomeryMul(Mpi *r, const Mpi *a, const Mpi *b, uint_t k,
   const Mpi *p, Mpi *t)
{
   cerror_t error;
   uint_t i;
...
cerror_t mpiMontgomeryRed(Mpi *r, const Mpi *a, uint_t k, const Mpi *p, Mpi *t)
{
   uint_t value;
   Mpi b;
