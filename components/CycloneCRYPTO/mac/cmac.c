...
cerror_t cmacCompute(const CipherAlgo *cipher, const void *key, size_t keyLen,
...
cerror_t cmacInit(CmacContext *context, const CipherAlgo *cipher,
...
cerror_t cmacFinal(CmacContext *context, uint8_t *mac, size_t macLen)
{
