...
__weak_func cerror_t hmacCompute(const HashAlgo *hash, const void *key, size_t keyLen,
...
__weak_func cerror_t hmacInit(HmacContext *context, const HashAlgo *hash,
