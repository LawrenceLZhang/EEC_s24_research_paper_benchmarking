...
cerror_t yarrowInit(YarrowContext *context)
{
   //Clear PRNG state
...
cerror_t yarrowSeed(YarrowContext *context, const uint8_t *input, size_t length)
{
   //Check parameters
...
cerror_t yarrowAddEntropy(YarrowContext *context, uint_t source,
...
cerror_t yarrowRead(YarrowContext *context, uint8_t *output, size_t length)
{
   size_t n;
