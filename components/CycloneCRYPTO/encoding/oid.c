...
cerror_t oidCheck(const uint8_t *oid, size_t oidLen)
{
   size_t i;
   size_t n;
...
cerror_t oidEncodeSubIdentifier(uint8_t *oid, size_t maxOidLen,
...
cerror_t oidDecodeSubIdentifier(const uint8_t *oid, size_t oidLen,
   size_t *pos, uint32_t *value)
{
   size_t i;
...
cerror_t oidFromString(const char_t *str, uint8_t *oid, size_t maxOidLen,
   size_t *oidLen)
{
   cerror_t error;
   size_t i;
...
cerror_t maskFromString(const char_t *str, uint8_t *mask, size_t maxMaskLen,
   size_t *maskLen)
{
   cerror_t error;
   size_t i;
