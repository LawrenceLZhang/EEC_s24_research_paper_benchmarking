...
cerror_t xtsInit(XtsContext *context, const CipherAlgo *cipherAlgo,
...
cerror_t xtsEncrypt(XtsContext *context, const uint8_t *i, const uint8_t *p,
...
cerror_t xtsDecrypt(XtsContext *context, const uint8_t *i, const uint8_t *c,
