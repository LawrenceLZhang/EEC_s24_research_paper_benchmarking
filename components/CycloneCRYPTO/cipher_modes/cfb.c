...
__weak_func cerror_t cfbEncrypt(const CipherAlgo *cipher, void *context, uint_t s,
...
__weak_func cerror_t cfbDecrypt(const CipherAlgo *cipher, void *context, uint_t s,
