...
cerror_t blowfishInit(BlowfishContext *context, const uint8_t *key,
   size_t keyLen);

cerror_t blowfishInitState(BlowfishContext *context);

cerror_t blowfishExpandKey(BlowfishContext *context, const uint8_t *salt,
