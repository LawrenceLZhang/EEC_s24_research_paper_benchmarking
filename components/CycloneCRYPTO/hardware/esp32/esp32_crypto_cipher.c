...
cerror_t aesInit(AesContext *context, const uint8_t *key, size_t keyLen)
{
   //Check parameters
...
cerror_t ecbEncrypt(const CipherAlgo *cipher, void *context,
...
cerror_t ecbDecrypt(const CipherAlgo *cipher, void *context,
...
cerror_t cbcEncrypt(const CipherAlgo *cipher, void *context,
...
cerror_t cbcDecrypt(const CipherAlgo *cipher, void *context,
...
cerror_t cfbEncrypt(const CipherAlgo *cipher, void *context, uint_t s,
   uint8_t *iv, const uint8_t *p, uint8_t *c, size_t length)
{
   cerror_t error;
...
cerror_t cfbDecrypt(const CipherAlgo *cipher, void *context, uint_t s,
   uint8_t *iv, const uint8_t *c, uint8_t *p, size_t length)
{
   cerror_t error;
...
cerror_t ofbEncrypt(const CipherAlgo *cipher, void *context, uint_t s,
   uint8_t *iv, const uint8_t *p, uint8_t *c, size_t length)
{
   cerror_t error;
...
cerror_t ctrEncrypt(const CipherAlgo *cipher, void *context, uint_t m,
