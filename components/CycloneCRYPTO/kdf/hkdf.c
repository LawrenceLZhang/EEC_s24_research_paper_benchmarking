...
cerror_t hkdf(const HashAlgo *hash, const uint8_t *ikm, size_t ikmLen,
...
cerror_t hkdfExtract(const HashAlgo *hash, const uint8_t *ikm, size_t ikmLen,
...
cerror_t hkdfExpand(const HashAlgo *hash, const uint8_t *prk, size_t prkLen,
