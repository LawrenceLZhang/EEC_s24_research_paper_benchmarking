...
cerror_t dhGenerateKeyPair(DhContext *context, const PrngAlgo *prngAlgo,
   void *prngContext);

cerror_t dhCheckPublicKey(DhParameters *params, const Mpi *publicKey);

cerror_t dhComputeSharedSecret(DhContext *context, uint8_t *output,
