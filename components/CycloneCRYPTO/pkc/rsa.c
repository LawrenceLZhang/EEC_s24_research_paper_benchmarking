...
cerror_t rsaesPkcs1v15Encrypt(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t rsaesPkcs1v15Decrypt(const RsaPrivateKey *key,
   ...
   size_t messageSize, size_t *messageLen)
{
   ...
   do
   {
      ...
      *messageLen = CRYPTO_SELECT_32(n, messageSize, badLength);
      ...
      error = (cerror_t) CRYPTO_SELECT_32(error, ERROR_BUFFER_OVERFLOW, badLength);
      error = (cerror_t) CRYPTO_SELECT_32(error, ERROR_DECRYPTION_FAILED, badPadding);
...
cerror_t rsaesOaepEncrypt(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t rsaesOaepDecrypt(const RsaPrivateKey *key, const HashAlgo *hash,
...
cerror_t rsassaPkcs1v15Sign(const RsaPrivateKey *key, const HashAlgo *hash,
...
cerror_t rsassaPkcs1v15Verify(const RsaPublicKey *key, const HashAlgo *hash,
...
cerror_t rsassaPssSign(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t rsassaPssVerify(const RsaPublicKey *key, const HashAlgo *hash,
...
__weak_func cerror_t rsaep(const RsaPublicKey *key, const Mpi *m, Mpi *c)
{
...
__weak_func cerror_t rsadp(const RsaPrivateKey *key, const Mpi *c, Mpi *m)
{
   cerror_t error;
   Mpi m1;
   Mpi m2;
...
cerror_t rsasp1(const RsaPrivateKey *key, const Mpi *m, Mpi *s)
{
...
cerror_t rsavp1(const RsaPublicKey *key, const Mpi *s, Mpi *m)
{
...
cerror_t emePkcs1v15Encode(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t emeOaepEncode(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t emsaPkcs1v15Encode(const HashAlgo *hash,
...
cerror_t emsaPkcs1v15Verify(const HashAlgo *hash, const uint8_t *digest,
...
cerror_t emsaPssEncode(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t emsaPssVerify(const HashAlgo *hash, size_t saltLen,
...
cerror_t rsaGenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
__weak_func cerror_t rsaGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
...
cerror_t rsaGeneratePublicKey(const RsaPrivateKey *privateKey,
   RsaPublicKey *publicKey)
{
   cerror_t error;
