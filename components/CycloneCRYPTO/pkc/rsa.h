...
cerror_t rsaep(const RsaPublicKey *key, const Mpi *m, Mpi *c);
cerror_t rsadp(const RsaPrivateKey *key, const Mpi *c, Mpi *m);
...
cerror_t rsaGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
